...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary hover:bg-indigo-500 text-white shadow-lg shadow-indigo-500/30 focus:ring-indigo-500 border border-transparent",
    secondary: "bg-surface hover:bg-slate-700 text-slate-200 border border-slate-600 focus:ring-slate-500",
